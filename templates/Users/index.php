                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <div class="text-center">
                            ...
                            <img class="profile-user-img img-fluid img-circle" src="https://png.pngtree.com/png-clipart/20220916/original/pngtree-for-profile-picture-png-image_8620121.png" alt="User profile picture">
                        </div>
                                ...
                                <?php foreach ($photos as $photo): ?>
                                    <div class="post">
                                        ...
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="https://png.pngtree.com/png-clipart/20220916/original/pngtree-for-profile-picture-png-image_8620121.png" alt="user image">
                                            <span class="username">
    ...
    <div class="direct-chat-messages">
        ...
        <?php foreach ($photo->comments as $comment): ?>
            <div class="direct-chat-msg">
                ...
                <img class="direct-chat-img" src="https://png.pngtree.com/png-clipart/20220916/original/pngtree-for-profile-picture-png-image_8620121.png" alt="message user image">
